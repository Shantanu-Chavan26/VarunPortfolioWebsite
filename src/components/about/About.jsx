      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            ...
            Node.js), and experienced in front-end and back-end technologies.
            Expertise in containerization with Docker and orchestration with
            Kubernetes, alongside continuous integration and deployment (CI/CD)
